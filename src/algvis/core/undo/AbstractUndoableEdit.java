...
//                " " + name;
        	name = "AbstractUndoableEdit.undoText" + " " + name;
        } else {
//            name = UIManager.getString("AbstractUndoableEdit.undoText");
            name = "AbstractUndoableEdit.undoText";
        }
...
//                " " + name;
            name = "AbstractUndoableEdit.redoText" + " " + name;
        } else {
//            name = UIManager.getString("AbstractUndoableEdit.redoText");
            name = "AbstractUndoableEdit.redoText";
        }
